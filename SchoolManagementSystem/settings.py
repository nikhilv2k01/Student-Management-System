...
SECRET_KEY = 'django-insecure-)&xn&rw)c4#$zra$5wcmd7dtlx17$0eb(o930umlh16(ln#jcn'
...
STATIC_URL = 'static/'
STATICFILES_DIRS=[
    os.path.join(BASE_DIR,'common/static/images')
]
MEDIA_URL='/media/'
...
EMAIL_HOST_USER = 'nikhilv2k01@gmail.com'
EMAIL_HOST_PASSWORD = 'N6i4k5h4i4l5'
